...
public class Main {
    public static void main(String[] args) {
        ...
        String[][] schedule = {{DayOfWeek.MONDAY.name(), "Learn programing java"}, {DayOfWeek.TUESDAY.name(), "Doctor's visit"}, {DayOfWeek.WEDNESDAY.name(), "Spending time with family"}, {DayOfWeek.THURSDAY.name(), "A trip to the store for a shopping spree"}, {DayOfWeek.FRIDAY.name(), "A corporate call in"}, {DayOfWeek.SATURDAY.name(), "Going to the shooting range with your friends"}, {DayOfWeek.SUNDAY.name(), "A trip to my parents' house"}
